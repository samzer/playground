...
## Development environment and release process
 ...
 - create virtualenv with Flask and widget_svm installed into it (latter is installed in
...
install it (`pip install widget_svm.tar.gz`), ensure that configuration file exists and
`WIDGET_SVM_SETTINGS` environment variable points to it, ensure that user has access to the
